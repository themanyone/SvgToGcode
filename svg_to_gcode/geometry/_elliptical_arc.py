...
class EllipticalArc(Curve):
    ...
    __slots__ = 'center', 'radii', 'rotation', 'start_angle', 'sweep_angle', 'end_angle', 'transformation', 'stroke_width', 'stroke', 'style'
    ...
    def __init__(self, center: Vector, radii: Vector, rotation: float, start_angle: float, sweep_angle: float,
                 transformation: None, stroke_width = "0", stroke="", style=""):
    ...
    def __repr__(self):
        return f"EllipticalArc(start: {self.start}, end: {self.end}, center: {self.center}, radii: {self.radii}," \
               f" rotation: {self.rotation}, start_angle: {self.start_angle}, sweep_angle: {self.sweep_angle}, stroke_width: {self.stroke_width}, stroke: {self.stroke}, style: {self.style})"
