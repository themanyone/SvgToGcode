...
class Line(Curve):
    ...
    __slots__ = 'slope', 'offset', 'stroke_width', 'style'

    def __init__(self, start, end, stroke_width="0", style=""):
        self.start = start
        self.end = end
    ...
    def __repr__(self):
        return f"Line(start:{self.start}, end:{self.end}, slope:{self.slope}, offset:{self.offset}, stroke_width:{self.stroke_width}, style: {self.style})"
